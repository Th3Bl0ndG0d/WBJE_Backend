...
//                            array = @ArraySchema(schema = @Schema(implementation = ReportSpecResponseDTO.class)),
...
public class ReportSpecController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    responseCode = "422",
                    description = "Domain validation failed (invalid ReportSpec structure or rules)",
                    content = @Content(schema = @Schema(implementation = ApiErrorDTO.class))
            )
    })
    @PostMapping
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    responseCode = "422",
                    description = "Domain validation failed (invalid fields or incompatible specifications)",
                    content = @Content(schema = @Schema(implementation = ApiErrorDTO.class))
            )
    })
    @GetMapping("/{id}")
    ...
    @ApiResponses({
            ...
            @ApiResponse(
                    responseCode = "409",
                    description = "ReportSpec is in use by one or more Reports (EntityInUseException)",
                    content = @Content(schema = @Schema(implementation = ApiErrorDTO.class))
            )
    })
    @DeleteMapping("/{id}")
