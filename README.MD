...
Zie het hoofdstuk [Rollen en Autorisatie (RBAC)](#rollen-en-autorisatie-rbac) voor de bijbehorende credentials *(incl. wachtwoorden)* en een toelichting op de rolverdeling.
...
>
> ⚠️ Bij de test “[SV] POST /job-templates – allowed (ROLE_ADMIN)” moet in Postman een daadwerkelijk testbestand worden geselecteerd in het `file`-veld. Indien hier geen bestand geselecteerd staat, zal deze test falen.
...
<a id="rollen-en-autorisatie-rbac"></a>
